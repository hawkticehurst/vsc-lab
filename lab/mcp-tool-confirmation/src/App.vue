	...
	<section class="chat-thread">
		<Message>
			<div style="display: flex; gap: 8px; align-items: center;">
				<span
					style="display: block; width: 30px; height: 30px; background-color: var(--vscode-descriptionForeground); border-radius: 50%;"
				></span>
		...
		<Message>
			...
			<p>
				Let me help you check the contents of your desktop folder. I'll first check which
				directories are allowed and then list the contents of the desktop folder if it's accessible.
			</p>
		</Message>
		<ToolConfirmation :id="'first-time-warning'">
			<p class="tool-confirmation-first-time-title">
				<vscode-icon name="warning"></vscode-icon>The <code class="snippet">filesystem</code> MCP
				server is being used for the first time.
			</p>
			<p>
				Do you trust "filesystem"? Executing its tools may pose risks. Proceed only if you trust the
				server.
			</p>
		...
		<ChatDetails :id="'first-time-confirm'" :toggleable="false">
			<template #default>
				<p
					class="tool-executed-title"
					style="display: flex; align-items: center; justify-content: space-between; width: 100%;"
				>
					<span
						>Confirmed permission to use the <code class="snippet">filesystem</code> MCP
						server</span
					>
					<vscode-icon
						name="check"
						style="color: var(--vscode-debugIcon-startForeground); padding-right: 5px;"
					></vscode-icon>
				</p>
			</template>
		</ChatDetails>
		<ChatDetails :id="'list-allowed-directories'" :toggleable="true">
			...
			<template #content>
				...
				<CodeBlock
					lang="json"
					:code="listAllowedInput"
					:theme="{ light: 'light-plus', dark: 'dark-plus' }"
				></CodeBlock>
				<ReadMore>
					<p style="font-weight: bold;">Tool Description:</p>
					<p>
						Returns the list of directories that this server is allowed to access. Use this to
						understand which directories are available before trying to access files.
					</p>
					<p>
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus non optio similique
						necessitatibus neque, est iure ratione officia voluptatum explicabo totam tenetur! Odio
						aliquid quaerat placeat minima quos! Amet sequi laboriosam ducimus repellat sed
						distinctio asperiores repudiandae nihil? Quasi, eligendi?
					</p>
					<p>
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit culpa corrupti, iusto ad
						fugit, ex pariatur reprehenderit consequatur veniam minus non at architecto accusamus
						nulla. Et ratione veniam eligendi id architecto doloremque tempore sint tempora soluta
						deserunt officia nesciunt modi pariatur ut autem necessitatibus, recusandae ipsum
						corporis, minima eius, accusantium ullam! Minima, facere. Laudantium impedit facilis
						possimus, quo natus voluptatem officiis vero, atque dicta dolore excepturi repudiandae
						veniam nisi odio voluptatum delectus quisquam ratione placeat assumenda sit.
					</p>
				</ReadMore>
			</template>
			<template #disclaimer>
				<p>Carefully review the proposed action and input.</p>
			</template>
		</ChatDetails>
			...
			<template #content>
				...
				<ReadMore>
					...
					<p>
						...
						essential for understanding directory structure and finding specific files within a
		...
		<Message :id="'list-directories-confirm-message'">
			...
			<ol>
				...
				<li>
					Fifteen folders named <code class="snippet">temp-1</code> to
					<code class="snippet">temp-15</code>
				</li>
			</ol>
