	...
	<details>
		...
		<ol>
			...
			<ul>
				...
				<li>
					Goal: Improve the ability to distinguish servers and tools via stronger visual hierarchy
				</li>
			</ul>
			<li>Prefix server names with "MCP Server:"</li>
			<ul>
				<li>
					Note: Also demoed "MCP Extension:" – might be the wrong term but the idea is that there
					can be variations on the prefix name used
				</li>
			...
			<ul>
				...
				<li>
					Bonus: Improves visual consistency / mental parse-ability of contribution sources text
				</li>
			</ul>
			<li>
				Suggestion: Add a contribution source label and server status to GitHub Copilot Chat server
			</li>
			<ul>
